...
struct ProcessInfoModule : public ctk::ApplicationModule {
     ...
     */
    /** PID of the process */
    ctk::ScalarOutput<int> processPID{this, "PID", "", "PID of the process", {"CS", "PROCESS"}};
    /** Time since process is running */
    ctk::ScalarOutput<int> runtime{this, "runtime", "s", "Time since process is running", {"CS", "PROCESS"}};
    /** @} */
    ...
    ctk::ScalarOutput<int> utime{this, "utime", "clock ticks", "user-mode CPU time accumulated by process", {"CS", "PROCESS"}};
    /** kernel-mode CPU time accumulated by process */
    ctk::ScalarOutput<int> stime{this, "stime", "clock ticks", "kernel-mode CPU time accumulated by process", {"CS", "PROCESS"}};
    /** cumulative utime of process and reaped children */
    ctk::ScalarOutput<int> cutime{this, "cutime", "clock ticks", "cumulative utime of process and reaped children", {"CS", "PROCESS"}};
    /** cumulative stime of process and reaped children */
    ctk::ScalarOutput<int> cstime{this, "cstime", "clock ticks", "cumulative stime of process and reaped children", {"CS", "PROCESS"}};
    /** start time of process -- seconds since 1-1-70 */
    ctk::ScalarOutput<int> startTime{this, "startTime", "clock ticks", "start time of process -- seconds since 1-1-70", {"CS", "PROCESS"}};

    //\todo Use long
    /** kernel scheduling priority */
    ctk::ScalarOutput<int> priority{this, "priority", "", "kernel scheduling priority", {"CS", "PROCESS"}};
    /** standard unix nice level of process */
    ctk::ScalarOutput<int> nice{this, "nice", "", "standard unix nice level of process", {"CS", "PROCESS"}};
    /** resident set size from /proc/#/stat (pages) */
    ctk::ScalarOutput<int> rss{this, "rss", "", "resident set size from /proc/#/stat (pages)", {"CS", "PROCESS"}};

    /**
     * CPU usage for measured between two control system loops.
     * The process time includes utime, stime, sutime, sctime.
     */
    ctk::ScalarOutput<double> pcpu{this, "pcpu", "%", "Actual CPU usage", {"CS", "PROCESS"}};
    /**
     * CPU usage averaged over the whole runtime of the process.
     * The process time includes utime, stime, sutime, sctime.
     */
    ctk::ScalarOutput<double> avpcpu{this, "avpcpu", "%", "Average CPU usage", {"CS", "PROCESS"}};
    /** @} */
